...
const ModalCreditInstall = ({ form, onChangeName, onAddBank, onRemoveBank,
    onChangeBank, onAddMonth, onChangeMonth, onSubmit, banks, onClose
}) => {

    return (
        <div>
            {/* You can open the modal using document.getElementById('ID').showModal() method */}
            <button className="btn btn-info text-white" onClick={() => document.getElementById('modalCredit').showModal()}>เพิ่มชุดบัตรเครดิต</button>
            <dialog id="modalCredit" className="modal">
                {/* w-11/12 max-w-3xl */}
                <div className="modal-box w-11/12 max-w-3xl text-text-primary">
                    <div className='flex justify-between'>
                        <h3 className="font-bold text-lg">สร้างชุดบัตรเครดิต</h3>
...
export default ModalCreditInstall