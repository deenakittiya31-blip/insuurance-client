                    ...
                    <div className="p-0.5 h-40 overflow-y-auto">
                        {
                            data.map((i) => (
                                <div
                                    key={i.id}
                                    className={`cursor-pointer p-2 capitalize hover:bg-neutral-100 ${selectedBrand === i.id ? 'bg-neutral-100 border-l-4 border-main' : ''
                                        }`}
                    ...
                    <div className="p-0.5 h-40 overflow-y-auto">
                        {
                            selectedData.map((i) => (
                                <div
                                    key={i.id}
                                    className={`cursor-pointer p-2 hover:bg-neutral-100 ${selectedBrand === i.id ? 'bg-neutral-100 border-l-4 border-main' : ''
                                        }`}
                                    onClick={() => setSelectedBrand(i.id)}
                                >
                                    {i.name}
